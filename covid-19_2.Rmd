...
source("CoronaNet/explore_coronanet_small.R") 
...
```{r, fobG, fig.cap="Cancel social gatherings?"}
source("BehaviouralCovid/fob.R")
g

```

```{r, fobH, fig.cap="Shake hands?"}

h

```

```{r, fobST, fig.cap="Close stores?"}

st
```


```{r, fobCRF, fig.cap="Curfew"}
