...
# Identifying best predictors using elastic net

A fundamental problem in identifying the factors that affect countries' policy responses and their effectiveness is that fact that the number of potential factors is large compared to the number of countries, that is, there are many variables and few observations. In order to identify the best predictors of countries behaviour and effectiveness, we employ the elastic net:
