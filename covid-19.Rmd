...
df<-read.csv(here::here("22042020_short.csv"))
...
#for some reason China's time trend stops in March. I need to check what went wrong in the compliling of the long data set.
