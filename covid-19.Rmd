...
df<-read.csv(here::here("21042020.csv"))
...
vars_intr<-c("Lock","log_GDP_pc","DaysDuration","Days_Movement_1death","ROL","HumidityDif","Humidity",
...
vars_best<-c("Lock","log_GDP_pc","DaysDuration","Days_Movement_1death","ROL","HumidityDif","Humidity",
...
dyn<-merge(days,df,by="Country",all=T)%>%
