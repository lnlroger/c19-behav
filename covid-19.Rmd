...
df<-read.csv("02052020_short.csv")





dfl<-read.csv("02052020_long.csv")
...
df%>%
  mutate(CaseLog=scale(log(TotalCases)))%>%
  ggscatterhist(x="Government.effectiveness.index", y="CaseLog",
              #size = "Population.density",
              #color = "blacl",
              #shape = 1,
              label = "Country",
...
df%>%
  ...
  mutate(DeathLog=scale(log(TotalDeaths)))%>%
  mutate(COL=100-IDV)%>%
  ggscatterhist(x="Government.effectiveness.index", y="DeathLog",
              #size = "Population.density",
              #color = "blacl",
              #shape = 1,
              label = "Country",
...
df%>%
 # filter(Movement)%>%
  #mutate(MoveLog=scale(log(Movement)))%>%
  mutate(COL=100-IDV)%>%
  ggscatterhist(x="Government.effectiveness.index", y="Movement",
              #size = "Population.density",
              #color = "blacl",
              #shape = 1,
              label = "Country",
...
```{r TightTC, fig.cap="Cultural Tightness by Total Cases"}

df%>%
  mutate(CaseLog=scale(log(TotalCases)))%>%
  mutate(COL=100-IDV)%>%
  ggscatterhist(x="Tightness", y="CaseLog",
              #size = "Population.density",
              #color = "blacl",
              #shape = 1,
              label = "Country",
...
```{r TightTD, fig.cap="Tightness by Total Death"}
df%>%
  filter(TotalDeaths>0)%>%
  mutate(DeathLog=scale(log(TotalDeaths)))%>%
  mutate(COL=100-IDV)%>%
  ggscatterhist(x="Tightness", y="DeathLog",
              #size = "Population.density",
              #color = "blacl",
              #shape = 1,
              label = "Country",
...
```{r TightnessMove, fig.cap="Cultural Tightness by Movement"}
df%>%
 # filter(Movement)%>%
  #mutate(MoveLog=scale(log(Movement)))%>%
  mutate(COL=100-IDV)%>%
  ggscatterhist(x="Tightness", y="Movement",
              #size = "Population.density",
              #color = "blacl",
              #shape = 1,
              label = "Country",
